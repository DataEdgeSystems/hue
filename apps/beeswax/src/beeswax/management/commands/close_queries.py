...
class Command(BaseCommand):
  ...
  def handle(self, *args, **options):
    ...
    queries = QueryHistory.objects.filter(last_state__in=[QueryHistory.STATE.expired, QueryHistory.STATE.failed, QueryHistory.STATE.available])
    ...
    for query in queries:
      try:
        ...
        query.last_state = QueryHistory.STATE.expired
        query.save()
      except Exception, e:
